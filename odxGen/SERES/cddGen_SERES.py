#!/usr/bin/env python3
"""Generate a SERES CDD by first generating PDX, then importing it with CANdelaStudio."""
...
DEFAULT_PDX_GENERATOR = SCRIPT_DIR / "pdxGen_SERES.py"
DEFAULT_PDX_TEMPLATE = SCRIPT_DIR / "templates" / "SERES_ECU_CAN_v15.pdx"
DEFAULT_CDD_TEMPLATE = SCRIPT_DIR / "templates" / "SERES_ECU_CAN_v15.cdd"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate SERES CDD by generating PDX and importing it with CANdelaStudio.")
    parser.add_argument("xlsx", nargs="?", type=Path, help="Input SERES diagnosis survey .xlsx file")
    parser.add_argument("--pdx-generator", type=Path, default=DEFAULT_PDX_GENERATOR, help="Path to pdxGen_SERES.py")
    parser.add_argument("--pdx-template", type=Path, default=DEFAULT_PDX_TEMPLATE, help="Template PDX passed to pdxGen_SERES.py")

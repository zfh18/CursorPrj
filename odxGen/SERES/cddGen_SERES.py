...
DEFAULT_PDX_GENERATOR = Path("pdxGen_SERES.py")
DEFAULT_PDX_TEMPLATE = Path("templates") / "SERES_ECU_CAN_v15.pdx"
DEFAULT_CDD_TEMPLATE = Path("templates") / "SERES_ECU_CAN_v15.cdd"
